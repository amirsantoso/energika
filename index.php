...
<section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      {
        echo '<header class="header" style="background-color:#4ccccc;">';
      }
      ?>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
            ...
            <li><a href="index.php?pilih=4.3"><i class="glyphicon glyphicon-user"></i> Setting User</a></li>
                  ...
                  <li class="sub-menu">
                      <a target="_blank" href="../../../phpmyadmin/db_export.php?db=db_koperasi&server=1&goto=db_qbe.php&token=042086e2593b7fe8fdb99ac76bb02f97" target="_blank">
              ...
              else if($_SESSION['level']=='user')
              {
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a href=index.php?pilih=1.2&aksi=ubah&kode_anggota=<?php echo $data['kode_anggota'];?>><i class="fa fa-bitcoin"></i><span style="font-size:120%; color:#fff;"> Menu Profile</span></a>
                  </li>
              ...
              <hr>
              <center>
              <p id="footer-text">Copyright &copy; <font color="red" alt="koperasi energika">Koperasi Energika | by <font color="red" alt="amirsantoso"><a href="https://amirsantoso.netlify.app/" target="_blank" rel="noopener noreferrer">Amir Santoso</a></font></p>
              </center>
              <!-- sidebar menu end-->
          </div>
      </aside>
