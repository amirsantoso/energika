...
<div class="form-group">
 ...
 <input type="text" class="form-control" name="kode_anggota" size="54" value="<?php echo nomer("A","kode_anggota","t_anggota");?>" readonly title="Kode harus diisi"/>
</div>
<div class="form-group">
...
<select name="level" class="form-control">
		<?php
            ...
            <option value="user" <?php if($a['level']=='user'){?>selected="selected"<?php }?>>User</option>
            <?php
            }
		?>
</select>
