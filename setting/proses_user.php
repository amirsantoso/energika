...
//$kode,$kode_user,$kode_petugas,$level,$username,$password,$tgl_entri,$nama
	switch ($pros)
	{
		...
		case "ubah" :
			$lib->ubahuser($kode,$kode_user,$kode_anggota,$kode_petugas,$level,$username,$password,$tgl_entri,$nama);
		break;
		
		case "hapus" :
			$lib->hapususer($kode,$kode_user,$kode_anggota,$kode_petugas,$level,$username,$password,$tgl_entri,$nama);
		break;
